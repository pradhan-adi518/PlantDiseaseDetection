...
# Data directories
dataset_dir = 'plantvillage_dataset/corn'  # Change this to your dataset path
...
callbacks = [
    ...
    ModelCheckpoint('best_model_corn_vgg16.keras', save_best_only=True),
...
model.save('crop_disease_model_corn_vgg16.keras')
