...
# Data directories
dataset_dir = 'plantvillage_dataset/potato'  # Change this to your dataset path
...
callbacks = [
    ...
    ModelCheckpoint('best_model_potato_vgg16_sunday.keras', save_best_only=True),
...
model.save('crop_disease_model_potato_vgg16_sunday.keras')
