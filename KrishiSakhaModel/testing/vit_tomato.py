...
dataset_dir = "plantvillage_dataset/tomato"  # Replace with your dataset path
...
callbacks = [
    ...
    ModelCheckpoint('best_vit_model_tomato_sunday.keras', save_best_only=True),
...
vit_model.save('vit_model_final_tomato_sunday.keras')
