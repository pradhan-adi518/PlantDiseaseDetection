...
# Data directories
dataset_dir = 'BangladeshiCrops/BangladeshiCrops/Crop___Disease/Rice'  # Change this to your dataset path
...
callbacks = [
    ...
    ModelCheckpoint('best_model_potato_vgg16.keras', save_best_only=True),
...
model.save('crop_disease_model_potato_vgg16.keras')
